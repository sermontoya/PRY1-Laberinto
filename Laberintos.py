...
#this function create a matrix fill with 0s 
...
#this function check that a maze already has a starting point
...
#this function create randomly a starting point in the maze
...
#this function remove the starting point in the maze 
